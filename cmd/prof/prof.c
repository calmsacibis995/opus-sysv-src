...
#endif
#if clipper
#define ISMAGIC(x)	(((unsigned short)x)==(unsigned short)CLIPPERMAGIC)
#endif
#if ns32000
#define ISMAGIC(x)	((((unsigned short)x)==(unsigned short)NS32GMAGIC) || \
...
#if !(vax || pdp11 || u3b || u3b15 || u3b2 || ns32000 || clipper || m88k)
...
#if (vax || u3b || u3b15 || u3b2 || ns32000 || clipper || m88k)
SYMENT nl;
#else
struct nlist nl;
#endif
...
#else /* opus */
	for(n=0;n<symttl;++n) 	/* scan in ascending order for auxiliaries */
#endif
