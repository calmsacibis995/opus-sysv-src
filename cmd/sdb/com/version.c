...
#else
#if clipper
	error("Intergraph Clipper sdb  Advanced Programming Utilities Issue 1.1");
#else
#if ns32000
	error("National Semiconductor NS32000 sdb  Advanced Programming Utilities Issue 1.1");
#else
#if m88k
	error("Motorola 88000 sdb  Advanced Programming Utilities Issue 1.1");
#endif
#endif
#endif
#endif
