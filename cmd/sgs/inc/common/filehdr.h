...
#define	M68TVMAGIC	0211
	...
	/* Motorola 88000 */
	/* I pulled this number out of thin air! (fnf) */
#define MC88MAGIC	0540	/* M88000 normal file */
...
#define AMDROMAGIC	0534	/* readonly sharable text segments */
	...
	/* Fairchild Clipper */
#define CLIPPERMAGIC	0577	/* magic number all kinds */

	/* NSC */
/* 0524 and 0525 reserved for NSC */
#define NS32GMAGIC      0524  /* kernel load by section header       */
#define NS32SMAGIC      0525  /* for modularity                      */

#define NS32WRMAGIC NS32GMAGIC
#define NS32ROMAGIC NS32GMAGIC
#define NS32MDMAGIC NS32SMAGIC
