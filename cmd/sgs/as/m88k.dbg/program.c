...
short valtype;
{
    ...
    fprintf(stderr, "CALLING MKSECT2\n");
...
static void pssection ()
{
    ...
    fprintf(stderr, "CALLING MKSECT1\n");
...
static int procmnemonic ()
{
    ...
    fprintf(stderr, "CALLING MKSECT3\n");
	    cgsect (mksect (symptr, STYP_TEXT));
    fprintf(stderr, "AFTER MKSECT3\n");
	}
    p = &scdata[1];
    fprintf(stderr, "AFTER MKSECT3: p->s_fd is %#x, p->s_fd->_flag is %#o\n", p->s_fd, p->s_fd->_flag);
