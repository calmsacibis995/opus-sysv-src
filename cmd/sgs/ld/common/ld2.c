...
#if CLIPPER
#define K8	0x1000L		/* Clipper page boundary */
#endif
#if M88K
#define K8	0x10000L	/* Specified by m88k OCS */
#endif
#if !CLIPPER && !M88K
#define	K8	0x2000L
#endif
...
#if CLIPPER || M88K
			textbegin += 0x7L;	/* align on 8-byte boundary */
			textbegin &= (~0x7L);
#endif
#endif
...
#if CLIPPER || M88K
	filoffst += 0x7L;		/* align on 8-byte boundary */
	filoffst &= (~0x7L);
#endif
