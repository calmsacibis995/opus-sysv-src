...
opconfigsa: $(SRCS) $(HDRS)
	-if m88k ; then \
	$(PFX)scc $(CFLAGS) $(LDFLAGS) -Dpm400 -o opconfigsa $(SRCS); \
	elif clipper ; then \
	$(PFX)scc $(CFLAGS) $(LDFLAGS) -Dpm300 -o opconfigsa $(SRCS); \
	elif ns32332 ; then \
	$(PFX)scc $(CFLAGS) $(LDFLAGS) -Dpm200 -o opconfigsa $(SRCS); \
	else \
	$(PFX)scc $(CFLAGS) $(LDFLAGS) -Dpm100 -o opconfigsa $(SRCS); \
	fi
