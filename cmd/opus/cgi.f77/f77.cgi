short v_appl_ (dev_handle, function, data_cnt, app_data)
short * dev_handle;
char  function;
short * data_cnt;
short  app_data;
...
short v_clswk_ (dev_handle)
short * dev_handle;
{
	return(v_clswk(* dev_handle));
}

short fd_connect_ (directory)
char  directory;
{
	return(fd_connect( directory));
}

short vcp_bitmap_ (dev_handle, bitmap_handle, source_rect, dest_orig)
short * dev_handle;
short * bitmap_handle;
short  source_rect;
short  dest_orig;
...
short vc_bitmap_ (dev_handle, xy, type, bitmap_handle)
short * dev_handle;
long  xy;
short * type;
long  bitmap_handle;
...
short v_curdown_ (dev_handle)
short * dev_handle;
{
	return(v_curdown(* dev_handle));
}

short v_curhome_ (dev_handle)
short * dev_handle;
{
	return(v_curhome(* dev_handle));
}

short v_curleft_ (dev_handle)
short * dev_handle;
{
	return(v_curleft(* dev_handle));
}

short v_curright_ (dev_handle)
short * dev_handle;
{
	return(v_curright(* dev_handle));
}

short v_curup_ (dev_handle)
short * dev_handle;
{
...
short v_dspcur_ (dev_handle, x, y)
short * dev_handle;
short * x;
short * y;
{
...
short v_enter_cur_ (dev_handle)
short * dev_handle;
{
	return(v_enter_cur(* dev_handle));
}

short v_eeol_ (dev_handle)
short * dev_handle;
{
	return(v_eeol(* dev_handle));
}

short v_eeos_ (dev_handle)
short * dev_handle;
{
	return(v_eeos(* dev_handle));
}

short v_exit_cur_ (dev_handle)
short * dev_handle;
{
...
short v_msg_ (dev_handle, message, wait)
short * dev_handle;
char  message;
short * wait;
{
...
short v_opnwk_ (work_in, dev_handle, work_out)
short  work_in;
short  dev_handle;
short  work_out;
{
...
short v_atext_ (dev_handle, string, x_out, y_out)
short * dev_handle;
char  string;
short  x_out;
short  y_out;
...
short v_arc_ (dev_handle, x, y, radius, begang, endang)
short * dev_handle;
short * x;
short * y;
short * radius;
...
short v_cellarray_ (dev_handle, xy, row_length, el_per_row, num_rows, wr_mode, colors)
short * dev_handle;
short  xy;
short * row_length;
short * el_per_row;
...
short v_circle_ (dev_handle, x, y, radius)
short * dev_handle;
short * x;
short * y;
short * radius;
...
short v_curtext_ (dev_handle, string)
short * dev_handle;
char  string;
{
...
short v_ellipse_ (dev_handle, x, y, x_radius, y_radius)
short * dev_handle;
short * x;
short * y;
short * x_radius;
...
short v_fillarea_ (dev_handle, count, xy)
short * dev_handle;
short * count;
short  xy;
{
...
short v_gtext_ (dev_handle, x, y, string)
short * dev_handle;
short * x;
short * y;
char  string;
...
short v_pieslice_ (dev_handle, x, y, radius, begang, endang)
short * dev_handle;
short * x;
short * y;
short * radius;
...
short v_pline_ (dev_handle, count, xy)
short * dev_handle;
short * count;
short  xy;
{
...
short v_pmarker_ (dev_handle, count, xy)
short * dev_handle;
short * count;
short  xy;
{
...
short fd_parse_ (qualified_name, buffer, space_available)
char  qualified_name;
char  buffer;
...
short fd_directory_ (fd, name, buffer, space_available)
short * fd;
char  name;
char  buffer;
short  space_available;
...
short fd_read_ (fd, count, buffer)
short * fd;
short * count;
char  buffer;
{
...
short v_rmcur_ (dev_handle)
short * dev_handle;
{
	return(v_rmcur(* dev_handle));
}

short fd_rename_ (fd, old_name, new_name)
short * fd;
char  old_name;
char  new_name;
{
...
short v_rvoff_ (dev_handle)
short * dev_handle;
{
	return(v_rvoff(* dev_handle));
}

short v_rvon_ (dev_handle)
short * dev_handle;
{
...
long fd_seek_ (fd, position, whence)
short * fd;
long * position;
short * whence;
{
...
short fd_write_ (fd, buffer, count)
short * fd;
char  buffer;
short * count;
{
...
short v_get_npels_ (dev_handle, xy, src, n)
short * dev_handle;
short  xy;
short  src;
short * n;
...
short v_put_npels_ (dev_handle, xy, dest, n)
short * dev_handle;
short  xy;
short  dest;
short * n;
...
short v_copy_npels_ (dev_handle, xy)
short * dev_handle;
short  xy;
{
