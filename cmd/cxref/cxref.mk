...
cpp.o:	$(CPP)/cpp.c
	...
	then \
		$(CC) $(FFLAG) $(CFLAGS) -I$(CPP) -DPD_MACH=D_clipper -DPD_SYS=D_unix $(CPP)/cpp.c; \
	elif ns32000 ; \
	then \
		$(CC) $(FFLAG) $(CFLAGS) -I$(CPP) -DPD_MACH=D_ns32000 -DPD_SYS=D_unix $(CPP)/cpp.c; \
	elif m88k ; \
	then \
		$(CC) $(FFLAG) $(CFLAGS) -I$(CPP) -DPD_MACH=D_m88k -DPD_SYS=D_unix $(CPP)/cpp.c; \
	fi
