...
all:
	if u3b; then \
		...
		cd m88k/pass1; $(MAKE) -f pass1.mk; \
		cd  ../pass2; $(MAKE) -f pass2.mk; exit; \
	elif clipper; then \
		cd clipper/pass1; $(MAKE) -f pass1.mk; \
		cd  ../pass2; $(MAKE) -f pass2.mk; exit; \
	elif ns32000; then \
...
clean:
	-if u3b; then \
		...
		cd m88k/pass1; $(MAKE) -f pass1.mk clean; \
		cd  ../pass2; $(MAKE) -f pass2.mk clean; exit; \
	elif clipper; then \
		cd clipper/pass1; $(MAKE) -f pass1.mk clean; \
		cd  ../pass2; $(MAKE) -f pass2.mk clean; exit; \
	elif ns32000; then \
...
clobber:
	-if u3b; then \
		...
		cd m88k/pass1; $(MAKE) -f pass1.mk clobber; \
		cd  ../pass2; $(MAKE) -f pass2.mk clobber; exit; \
	elif clipper; then \
		cd clipper/pass1; $(MAKE) -f pass1.mk clobber; \
		cd  ../pass2; $(MAKE) -f pass2.mk clobber; exit; \
	elif ns32000; then \
