...
#if TARGET == OPUS
#ifdef FLEXNAMES
extern flag longnames;
#define TOKLEN	((longnames) ? VL : STDVL)
#else
#define TOKLEN VL
#endif
#endif
...
ckfree(infname);	/* free only when there are more include files */
