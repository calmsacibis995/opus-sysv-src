...
fsdb::\
	...
	-if pdp11; \
	then \
		$(CC) $(CFLAGS) -DFsTYPE=1 -I$(INC) -o $(TESTDIR)/fsdb fsdb.c $(LDLIBS);\
	elif ns32000 || clipper || m88k; \
	then \
		$(CC) $(CFLAGS) -I$(INC) -o $(TESTDIR)/fsdb fsdb.c $(LDLIBS);\
	else \
		$(CC) $(CFLAGS) -DFsTYPE=2 -I$(INC) -o $(TESTDIR)/fsdb fsdb.c $(LDLIBS);\
		$(CC) $(CFLAGS) -DFsTYPE=1 -I$(INC) -o $(TESTDIR)/fsdb1b fsdb.c $(LDLIBS); \
	fi
