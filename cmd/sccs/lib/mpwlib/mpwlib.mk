...
move.o:	
	if vax; then	\
		...
		$(CC) -c $(CFLAGS) ns32000/move.s	; \
	elif clipper; then	\
		$(CC) -c $(CFLAGS) clipper/move.c	; \
	elif m88k; then	\
		$(CC) -c $(CFLAGS) m88k/move.c	; \
	else	\
...
alloca.o:
	if vax; then	\
		...
		$(CC) -c $(CFLAGS) ns32000/alloca.s	; \
	elif clipper; then	\
		$(CC) -c $(CFLAGS) clipper/alloca.s	; \
	elif m88k; then	\
		$(CC) -c $(CFLAGS) m88k/alloca.s	; \
	else	\
