...
db:	install_fetch
	...
	if [ "${ROOT}" != "" ]; then \
		/usr/bin/replace $(TMP)/descriptions.a $(TMP)/descriptions/*; \
		/usr/bin/replace $(TMP)/examples.a $(TMP)/examples/*; \
		/usr/bin/replace $(TMP)/options.a $(TMP)/options/*; \
		/usr/bin/replace $(TMP)/glossary.a $(TMP)/glossary/*; \
		/usr/bin/replace $(TMP)/screens.a $(TMP)/screens/*; \
		/usr/bin/replace $(TMP)/screens.a $(TMP)/screensfoot/*; \
	else \
