...
$(LIBRARY)(errtext.o):	 errmsg.h \
		 ...
		 $(INC)/varargs.h 
		if clipper && ghs ; then \
			/lib/comp -X62 -X74 -X82 -X83 -I$(ROOT)/usr/include \
				-E errtext.c > errtext.gh.c ; \
			$(CC) -c -O -I$(INC) errtext.gh.c ; \
			mv errtext.gh.o errtext.o ; \
			rm -f errtext.gh.c ; \
		else \
			$(CC) -c -O -I$(INC) errtext.c ; \
		fi
		$(AR) rv $(LIBRARY) errtext.o
...
install: ALL
	if clipper && ghs ; then \
		cpset $(LIBRARY) $(LIB) 0444 bin bin ; \
	else \
