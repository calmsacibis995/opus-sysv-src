...
all:
	if m88k ; then $(MAKE) -e -f libc_m88k.mk specific MACHINE=m88k; fi
#	if pdp11 ; then make -e -f libc_m88k.mk specific MACHINE=pdp11 ; fi
#	if vax ;   then make -e -f libc_m88k.mk specific MACHINE=vax ; fi
#	if u3b ;   then make -e -f libc_m88k.mk specific MACHINE=u3b ; fi
#	if u3b15 || u3b5 || u3b2 ;  then make -e -f libc_m88k.mk DEFLIST=-DM32 \
#				specific MACHINE=m32 ; fi
#	if u370 ;  then make -e -f libc_m88k.mk specific MACHINE=u370 ; fi
