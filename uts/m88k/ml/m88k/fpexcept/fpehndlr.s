...
;  to be handled.
	or.u	r3,r0,hi16(0x10000000+0x400) ;get upper half-word of 
						 ;first frame pointer
	st	r0,r3,lo16(0x10000000+0x400) ;get lower half-word of 
	;br	_fpertn

	st	r1,r31,0
	
	or.u	r2,r0,hi16(0x10000000 + 0x404) ;get upper half-word of 
						 ;first frame pointer
	or	r2,r2,lo16(0x10000000 + 0x404) ;get lower half-word of 
	add	r2,r2,10*40   ; Work backwards
findfull:
	subu	r2,r2,40
	ld	r3,r2,0
...
nxtfpe:
	...
	or.u	r3,r0,hi16(0x10000000 + 0x404) ;get upper half-word of 
						 ;first frame pointer
	or	r3,r3,lo16(0x10000000 + 0x404) ;get lower half-word of 
	subu	r3,r2,r3
