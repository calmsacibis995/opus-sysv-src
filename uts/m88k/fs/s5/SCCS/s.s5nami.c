h35871
s 00002/00000/00584
d D 1.2 91/04/18 17:56:42 root 2 1
c Truncate a directory when it is removed, so readdir() will return NULL
e
s 00584/00000/00000
d D 1.1 90/03/06 12:43:55 root 1 0
c date and time created 90/03/06 12:43:55 by root
e
u
U
t
...
E 2
	...
	case NI_DELDIR:
		...
		if (dip->i_ftype == IFDIR && flagp->cmd != NI_DELDIR 
								&& !suser()) 
			goto delfail;
		if (dip->i_flag&ITEXT)
