...
#ifndef lint
static char SysVr3NFSID[] = "@(#)rpc_prot.c	4.1 LAI System V NFS Release 3.2/V3	source";
#endif
/*
 * static char sccsid[] = "@(#)rpc_prot.c 1.23 85/09/27 Copyr 1984 Sun Micro";
 */
	...
	register struct rpc_msg *rmsg;
{
	...
	if (xdrs->x_op == XDR_DECODE &&
		...
		if (oa->oa_length) {
			...
			if (oa->oa_base == NULL) {
				oa->oa_base = kmem_alloc(oa->oa_length);
			}
