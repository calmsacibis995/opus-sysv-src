h52637
s 00008/00008/00179
d D 1.2 90/04/24 11:17:28 root 2 1
c added volatile defintions.
e
s 00187/00000/00000
d D 1.1 90/03/06 12:29:29 root 1 0
c date and time created 90/03/06 12:29:29 by root
e
u
U
t
...
#if m88k
D 2
#define	SR0	(unsigned char *) 0x5fffff20
#define	SR1	(unsigned char *) 0x5fffff24
#define	SR2	(unsigned char *) 0x5fffff28
#define	SR3	(unsigned char *) 0x5fffff2C
#define	CNTRL0	(unsigned char *) 0x5fffff30
E 2
I 2
...
D 2
#define COMMPAGE0 ((struct commpage *)(0))		/* R/O Commpage */
#define COMMPAGE ((struct commpage *)(DMASPACE))	/* R/W Commpage */
E 2
I 2
