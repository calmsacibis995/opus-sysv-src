...
#define paddr(X)	(paddr_t)(X->b_un.b_addr)
	...
	int	b_dpages;		/* number dma pgs allocated */
	int	b_dma;			/* starting dma page */
	ulong	b_rcount;		/* running xfer count */
	paddr_t	b_raddr;		/* running address */
	daddr_t	b_rblkno;		/* running blk number */
} buf_t;

extern	struct	buf    *bufz;		/* pointer to buffer pool headers */
...
extern	int		pfreecnt;
extern	struct	buf    *pbufz;		/* pointer to physical buffer headers */
extern	char	       *bufferz;
...
#define	B_WAIT	  0x1000
#define	B_LOPRI	  0x2000
#define	B_LOPRIQ  0x4000
#define	B_KPHYS	  0x8000
#define B_VERIFY  0x10000
#define B_FORMAT  0x20000
#define B_RAMRD   0x40000
#define B_RAMWT	  0x80000
