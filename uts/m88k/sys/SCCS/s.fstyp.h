h28292
s 00097/00000/00000
d D 1.1 90/03/06 12:29:42 root 1 0
c date and time created 90/03/06 12:29:42 by root
e
u
U
t
T
I 1
#ifndef _SYS_FSTYP_H_
#define _SYS_FSTYP_H_


/*	Copyright (c) 1989 Opus Systems	*/
/*	      All Rights Reserved	*/

/*      @(#)fstyp.h	2.1 System V NFS  source        */
...
#define FS_NOICACHE	0x1	/* Retain old inodes in in-core cache. */
				...
				/* this clear */
#define FS_RECYCLE	0x2	/* Invoke the file system dependant iput() */
				/* routine when recycling an inode even when */
				/* not changing the fstyp in the inode. */
...
#define FS_SELECT(ip, mode)	(*(ip)->i_fstypp->fs_select)(ip, mode)
...
#define FS_SELECT(ip, mode)	(*fstypsw[(ip)->i_fstyp].fs_select)(ip, mode)
