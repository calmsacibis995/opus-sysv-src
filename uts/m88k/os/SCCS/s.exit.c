h32693
s 00280/00000/00000
d D 1.1 90/03/06 12:27:55 root 1 0
c date and time created 90/03/06 12:27:55 by root
e
u
U
t
...
#ident	"@(#)kern-port:os/exit.c	35.1"
#include "sys/types.h"
#include "sys/param.h"
...
exit(rv)
{
	...
	p->p_flag &= ~(STRC|SKILL);
	i = splhi();
	bzero((caddr_t) &p->p_itimer, sizeof(p->p_itimer));
	scanitimer();
	splx(i);
	for (i = 0; i < NSIG; i++)
