 ...
 */
typedef	enum	fp_rnd {
    FP_RN = 0x0000,	/* round to nearest representable number, tie -> even */
    FP_RZ = 0x4000,	/* round toward zero (truncate)			      */
    FP_RP = 0xc000,	/* round toward plus infinity			      */
    FP_RM = 0x8000,	/* round toward minus infinity			      */
    } fp_rnd;
