 ...
 *	All Rights Reserved.
 */
/*      @(#)ypv1_prot.h	3.1 LAI System V NFS Release 3.2/V3	source        */
/*      @(#)ypv1_prot.h 1.2 85/11/19 Copyr 1985 Sun Microsystems, Inc */
...
#define YPOLDPROC_NULL		((ulong)0)
#define YPOLDPROC_DOMAIN	((ulong)1)
#define YPOLDPROC_DOMAIN_NONACK	((ulong)2)
#define YPOLDPROC_MATCH		((ulong)3)
#define YPOLDPROC_FIRST		((ulong)4)
#define YPOLDPROC_NEXT		((ulong)5)
#define YPOLDPROC_POLL		((ulong)6)
#define YPOLDPROC_PUSH		((ulong)7)
#define YPOLDPROC_PULL		((ulong)8)
#define YPOLDPROC_GET		((ulong)9)
