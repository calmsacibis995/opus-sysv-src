 ...
 *	All Rights Reserved.
 */
/*      @(#)yp_prot.h	3.1 LAI System V NFS Release 3.2/V3	source        */
/*      @(#)yp_prot.h 1.11 85/11/19 Copyr 1985 Sun Microsystems, Inc */
...
#define YPPROG		((ulong)100004)
#define YPVERS		((ulong)2)
#define YPVERS_ORIG	((ulong)1)
#define YPMAXRECORD	((ulong)1024)
#define YPMAXDOMAIN	((ulong)64)
#define YPMAXMAP	((ulong)64)
#define YPMAXPEER	((ulong)256)
...
#define YPPROC_NULL	((ulong)0)
#define YPPROC_DOMAIN	((ulong)1)
#define YPPROC_DOMAIN_NONACK ((ulong)2)
#define YPPROC_MATCH	((ulong)3)
#define YPPROC_FIRST	((ulong)4)
#define YPPROC_NEXT	((ulong)5)
#define YPPROC_XFR	((ulong)6)
#define YPPROC_CLEAR	((ulong)7)
#define YPPROC_ALL	((ulong)8)
#define YPPROC_MASTER	((ulong)9)
#define YPPROC_ORDER	((ulong)10)
#define YPPROC_MAPLIST	((ulong)11)
...
#define YPBINDPROG		((ulong)100007)
#define YPBINDVERS		((ulong)2)
#define YPBINDVERS_ORIG		((ulong)1)

/* Procedure symbols */

#define YPBINDPROC_NULL		((ulong)0)
#define YPBINDPROC_DOMAIN	((ulong)1)
#define YPBINDPROC_SETDOM	((ulong)2)
/*
 ...
 */
#define YPPUSHVERS		((ulong)1)
#define YPPUSHVERS_ORIG		((ulong)1)

/* Procedure symbols */

#define YPPUSHPROC_NULL		((ulong)0)
#define YPPUSHPROC_XFRRESP	((ulong)1)
